...
class MobileConfigControllerTest {
    ...
    private companion object { const val CONFIG = """{"schemaVersion":1,"revision":"fixture-revision","compatibility":{"requestedSchemaVersion":1,"appliedSchemaVersion":1,"capabilities":["config_schema_v1"],"unsupportedSettings":[]},"securityPolicy":{"minimumProtocolVersion":1,"minimumSdkVersion":null,"identityMode":"sdk_interface","anonymousScope":"installation_generation","nativePlacement":"host_app"},"appearance":{"accent":"#000000","botName":"Bot","botSubtitle":"Sub","greeting":"Hi","headerAvatar":{"mode":"initials","text":"B","data":null},"light":{"background":"#fff","outgoing":"#000","outgoingText":"#fff","incoming":"#eee","incomingText":"#000"},"dark":{"enabled":true,"background":"#000","outgoing":"#fff","outgoingText":"#000","incoming":"#111","incomingText":"#fff"}},"features":{"insertLink":false,"insertCode":false,"emoji":true,"gifs":false,"voice":false,"fileUpload":false,"transcriptDownload":false,"soundNotifications":false,"showTimestamps":true,"faqButton":{"enabled":false,"label":"Help"}},"content":{"faqs":[],"tabs":{"enabled":true,"tabs":[],"defaultTab":"home"},"search":{"enabled":true,"placeholder":"Search","showSearchInHome":true},"onboarding":{"enabled":false,"title":"Welcome","showProgress":false,"items":[]},"homeSections":[]},"identityMode":"sdk_interface","unsupportedWidgetSettings":[]}""" }
}
